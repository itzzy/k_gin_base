...
# # 创建动画
# frames = [Image.fromarray(img_brightened[i]) for i in range(len(img_brightened))]

# # 保存为GIF
# frames[0].save('output_kgin_1122_100_test.gif', save_all=True, append_images=frames[1:], duration=500, loop=0)
