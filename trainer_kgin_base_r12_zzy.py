...
# nohup python train_kgin_base_r12_zzy.py --config config_kgin_base_r12_zzy.yaml > log_kgin_base_r12_0511.txt 2>&1 &
...
class TrainerAbstract:
    def __init__(self, config):
        ...
        if self.debug: config.general.exp_name = 'test_kgin_base_r12_zzy'
...
class TrainerKInterpolator(TrainerAbstract):
    ...
    def run_test(self):
        ...
        with torch.no_grad():
            ...
            try:
                np.save('out_kgin_base_r12_zzy_0511.npy', out)
            except OSError as e:
