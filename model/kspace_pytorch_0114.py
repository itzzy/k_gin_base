...
def data_consistency(k, k0, mask, noise_lvl=None):
    ...
    """
    '''
    data_consistency-k: torch.Size([1, 18, 192, 192, 2])
    data_consistency-k0: torch.Size([1, 18, 192, 192, 2])
    data_consistency-mask: torch.Size([1, 18, 192, 192, 2])
    '''
    # print('data_consistency-k:',k.shape)
    # print('data_consistency-k0:',k0.shape)
    # print('data_consistency-mask:',mask.shape)
